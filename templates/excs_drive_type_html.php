...
<div class="eh-section-full">
    ...
    <div class="eh-body">
        <div class="eh-row">
            <div class="eh-col-12">
                <h2 class="tbl-headline">Drive Type</h2>
                <a href="<?php echo admin_url();?>admin.php?page=excs-system-drive-type&add=1" class="action-add">Add New</a>
                    	...
                    	<?php if(count($results)>0){ 
                    		...
                    		foreach ($results as $result){ ?>
                    			<tr>
                    			    ...
                    			    <th>
                    			    	<a href="<?php echo admin_url();?>admin.php?page=excs-system-drive-type&edit=1&id=<?php echo $result->id;?>" class="action-edit">Edit</a><a href="<?php echo admin_url();?>admin.php?page=excs-system-drive-type&delete=1&id=<?php echo $result->id;?>" class="action-delete">X</a>
                    			    </th>
                    			</tr>
                    	<?php $i++; }}?>
